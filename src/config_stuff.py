...
SHOPIFY_DURAND_NAME = BASE_PATH + 'plaid_room/config/durand_shopify.key'
SHOPIFY_IKEBE_NAME = BASE_PATH + 'plaid_room/config/ikebe_shopify.key'
SHOPIFY_DLO3_NAME = BASE_PATH + 'plaid_room/config/dlo3_shopify.key'
...
BLOWOUT_PERCENTAGE_FILE = BASE_PATH + 'plaid_room/config/bf_blowout.csv'
